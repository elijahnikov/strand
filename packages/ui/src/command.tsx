...
function CommandPanel({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className="relative -mx-px rounded-[calc(var(--radius-xl)+5px)] bg-ui-bg-base [clip-path:inset(0_1px)] before:pointer-events-none"
      {...props}
    />
  );
}
