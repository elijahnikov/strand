export const theme = {
  extend: {
    colors: {
      ui: {
        ...
        button: {
          ...
          recall: {
            DEFAULT: "var(--button-recall)",
            hover: {
              DEFAULT: "var(--button-recall-hover)",
            },
            pressed: {
              DEFAULT: "var(--button-recall-pressed)",
            },
          },
        },
        fg: {
    ...
    boxShadow: {
      ...
      "buttons-recall": "var(--buttons-recall)",
      "buttons-recall-focus": "var(--buttons-recall-focus)",
